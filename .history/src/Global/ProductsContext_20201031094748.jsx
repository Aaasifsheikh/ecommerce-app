...
import hplaptop from "../Image/hp laptop";
...
const ProductsContextProvider = (props) => {
  const [products] = useState([
    ...
    { id: 8, name: "Mi Powerbank-faster than you think", price: 2749, cutprice: 3999, Image: powerbank, rating: "🌟🌟🌟🌟", status: "hot" },
    { id: 8, name: "Bicycle-For All Gene", price: 8500, cutprice: 11780, Image: bicycle, rating: "🌟🌟🌟🌟🌟", status: "new" },
    { id: 8, name: "Ring", price: 3700, cutprice: 4800, Image: ring, rating: "🌟🌟🌟🌟", status: "new" },
