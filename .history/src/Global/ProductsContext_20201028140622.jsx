...
const ProductsContextProvider = (props) => {
  const [products] = useState([
    { id: 1, name: "Headphone", price: 1800, cutprice: 2200,  Image: Headphone, rating: "🌟🌟🌟🌟", status: "hot" },
    { id: 2, name: "DSLR", price: 13500, cutprice: 18000, Image: DSLR, rating: "🌟🌟🌟🌟🌟" , status: "hot" },
    { id: 3, name: "Iphone", price: 48000, cutprice: 62000, Image: iphone, rating: "🌟🌟🌟🌟", status: "hot" },
    ...
    { id: 6, name: "Shoes", price: 2800, cutprice: 4500, Image: shoes, rating: "🌟🌟🌟🌟🌟", status: "hot" },
    { id: 7, name: "Watch", price: 5200, cutprice: 9500, Image: watch, rating: "🌟🌟🌟", status: "hot" },
    { id: 8, name: "Ring", price: 3700, cutprice: 4800, Image: ring, rating: "🌟🌟🌟🌟", status: "hot" },
  ]);
