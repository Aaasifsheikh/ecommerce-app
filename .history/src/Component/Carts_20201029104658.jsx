...
import RemoveIcon from '@material-ui/icons/Remove';import DeleteIcon from '@material-ui/icons/Delete';
    ...
    <div className="cart-container">
      <div className="cart-details" style={{ marginTop: "100px" }}>
        {shoppingCart.length > 0 ? shoppingCart.map(cart=>(
            ...
            <span className="increament"><AddIcon /></span>
            <span className="product_qty">{cart.quantity}</span>
            <span className="decreament">< /></span>
