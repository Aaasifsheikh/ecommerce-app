...
import StripeChe{ckout from "react-stripe-checkout";
const Carts = (e) => {
          ...
          ? shoppingCart.map((cart) => (
              <div className="cart" key={cart.id}>
                <span className="cart_image">
                  <img src={cart.Image} alt="Not_found" />
                </span>
        ...
        <div className="cart-summery">
          <div className="summery">
            ...
            <div className="stripe-section">
              <StripeCheckout
                stripeKey="pk_test_51Hhqa7CKdJBLBcP2iMOyIS6sLmR8Zr1crIFJsF7g4hVxCqr3FgX2r3bBohO0pfDMDP5nEQ21Vvq18B41Ke3giI8M00lszfiek5"
                token={handleToken}
                billingAddress
                shippingAddress
