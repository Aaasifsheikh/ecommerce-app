    ...
    <div className="cart-container">
      <div className="cart-details" style={{ marginTop: "100px" }}>
        {shoppingCart.length > 0 ? shoppingCart.map(cart=>(
            ...
            <span className="inc" onClick={()=>dispatch({type: "INC", id:card.id, cart:cart})}><AddIcon className="incIcon" /></span>
            <span className="product_qty">{cart.qty}</span>
            <span className="dec"><RemoveIcon className="decIcon" /></span>
            <span className="total_price">₹{cart.price}.00</span>
